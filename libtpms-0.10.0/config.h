...
/* Define to 1 if you have the <blapi.h> header file. */
/* #undef HAVE_BLAPI_H */
...
/* Define to 1 if you have the <sslerr.h> header file. */
/* #undef HAVE_SSLERR_H */
...
/* #undef USE_FREEBL_CRYPTO_LIBRARY */
